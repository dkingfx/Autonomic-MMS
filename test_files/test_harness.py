...
def test2():
    ...
    sequence[5] = ('get_power', x.create_send_message(
        "PowerOff", controller, zone))
    sequence[10] = ('get_source', x.create_send_message(
        "GetSource", controller, zone))
    sequence[15] = ('get_source', x.create_send_message(
        "PowerOn", controller, zone))
